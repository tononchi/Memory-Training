...
本資料は、文部科学省「小学校学習指導要領（平成29年告示）」の別表「学年別漢字配当表」に基づく、各学年で学習する漢字（教育漢字／学習漢字）の一覧です。**2020年4月1日に完全施行された現行版（全1026字）** を掲載しています。

- 速読トレーニングアプリ（[../README.md](../README.md)）の出題（学年別・漢字込み問題）で、学年に応じた漢字のみを使うための参照表です。
- 各学年では、**当該学年に配当された漢字を「読む」こと、前の学年までに配当された漢字を「書く」こと**を身につけるよう指導するとされています。
- データ出典：Wikipedia「学年別漢字配当表」（MediaWiki API 経由で取得）。字数は公式の配当字数（80/160/200/202/193/191＝1026字）と一致することを確認済み。
- 最終更新：2026-06-29
...
2017年告示・2020年施行の現行版では、**都道府県名に使われる20字が新たに追加**され（中学校→第4学年）、あわせて学年間で37字が移動しました。第4学年で都道府県名をすべて学ぶための再配置です。

- **中学校 → 第4学年（20字・新規追加）**：茨 媛 岡 潟 岐 熊 香 佐 埼 崎 滋 鹿 縄 井 沖 栃 奈 梨 阪 阜
- **第5学年 → 第4学年（4字）**：賀 群 徳 富
- **第6学年 → 第4学年（1字）**：城
- **第4学年 → 第5学年（21字）**：囲 紀 喜 救 型 航 告 殺 士 史 象 賞 貯 停 堂 得 毒 費 粉 脈 歴
- **第4学年 → 第6学年（2字）**：胃 腸
- **第5学年 → 第6学年（9字）**：恩 券 承 舌 銭 退 敵 俵 預

> 旧版（1989〜2016年施行・1006字）に基づく教材・問題集では、上記の漢字の配当学年が異なる場合があります。出題時は本（現行）表を基準にしてください。

## 出典

- 文部科学省「小学校学習指導要領（平成29年告示）」別表 学年別漢字配当表
- Wikipedia「学年別漢字配当表」 — https://ja.wikipedia.org/wiki/学年別漢字配当表
